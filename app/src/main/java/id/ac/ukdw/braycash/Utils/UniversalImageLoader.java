...
public class UniversalImageLoader {
    ...
    private static final int defaultImage = R.drawable.ic_imgloading;
    ...
    /**
     * these method can be used to set images that are static.
    ...
    public static void setImage(String imgURL, ImageView image, final ProgressBar mProgressBar, String append) {
        /**
         * If you are getting errors on setting image from the internet,
         * don't forget to set the internet permission on AndroidManifest.xml
         */
